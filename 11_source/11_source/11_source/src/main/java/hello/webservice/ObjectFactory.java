 ...
 * generated in the hello.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHello_QNAME = new QName("http://hello/", "sayHello");
    private final static QName _SayHelloResponse_QNAME = new QName("http://hello/", "sayHelloResponse");
    private final static QName _SendMessage_QNAME = new QName("http://hello/", "sendMessage");
    private final static QName _SendMessageResponse_QNAME = new QName("http://hello/", "sendMessageResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: hello.webservice
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://hello/", name = "sayHello")
     ...
     */
    @XmlElementDecl(namespace = "http://hello/", name = "sayHelloResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://hello/", name = "sendMessage")
     ...
     */
    @XmlElementDecl(namespace = "http://hello/", name = "sendMessageResponse")
